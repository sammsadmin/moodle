...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('enrol_payfast/customint1', get_string('customint1', 'enrol_payfast'), '', 0, PARAM_FLOAT, 4));

    $settings->add(new admin_setting_configtext('enrol_payfast/customint2', get_string('customint2', 'enrol_payfast'), '', 0, PARAM_FLOAT, 4));
    ...
    $settings->add(new admin_setting_configtext('enrol_payfast/customtext1', get_string('customtext1', 'enrol_payfast'), '', '', PARAM_RAW));
