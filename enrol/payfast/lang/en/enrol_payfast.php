...
$string['customint1'] = 'Student enrol cost';
$string['customint1_help'] = 'Enrol cost for a user with system role student.';
$string['customint2'] = 'Member enrol cost';
$string['customint2_help'] = 'Enrol cost for a user with system role member.';
...
$string['customtext1'] = 'Webinar link';
$string['customtext1_help'] = 'URL to get access to the webinar.';
$string['enrolmentnewuser'] = '{$a->user} has enrolled in course "{$a->course}". To access the webinar, please use this link {$a->webinarlink}';
$string['welcometocoursetext'] = 'Welcome to {$a->coursename}!

You can access the webinar at {$a->webinarlink}.

Please find the invoice for your purchase attached. 

If you have not done so already, you should edit your profile page so that we can learn more about you: {$a->profileurl}.';
