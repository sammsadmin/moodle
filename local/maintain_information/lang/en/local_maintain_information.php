...
$string['disability_certificate'] = 'Please upload proof if you have a registered disability (medical certificate, psychologist’s report, etc.)';
$string['contact_details'] = 'Contact details';
$string['cellphone_number'] = 'Cell phone';
$string['phone_number'] = 'Home phone';
...
$string['update_population_group'] = 'Update population groups';
$string['update_nationality'] = 'Update nationalities';
$string['update_home_language'] = 'Update home languages';
