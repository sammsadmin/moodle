...
/**
 * Provides {@link block_learning_log\external\hide_done_items} trait.
 *
...
/**
 * Trait implementing the external function block_learning_log_hide_done_items.
 */
trait hide_done_items {
    ...
    public static function hide_done_items($instanceid, $hide): string {
        ...
        $DB->set_field('block_learning_log', 'hide', (int) $hide, $params);
