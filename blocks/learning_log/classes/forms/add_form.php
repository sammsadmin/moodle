...
class block_learning_log_add_form extends moodleform {
    public function definition() {
        ...
        $mform->addElement('text', 'description', get_string('description', 'block_learning_log'),['placeholder' => get_string('description_ph', 'block_learning_log')]);
        $mform->setType('description', PARAM_TEXT);
        $mform->addRule('description', null, 'required', null, 'client');

        $mform->addElement('text', 'organisation', get_string('organisation', 'block_learning_log'),['placeholder' => get_string('organisation_ph', 'block_learning_log')]);
        ...
        $mform->addElement('text', 'duration', get_string('duration', 'block_learning_log'),['placeholder' => get_string('duration_ph', 'block_learning_log')]);
