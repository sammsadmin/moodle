...
/**
 * Provides {@link block_learning_log_external_testcase} class.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_learning_log_external_testcase extends advanced_testcase {
    ...
    public function test_add_item_no_permission() {
        ...
        unassign_capability('block/learning_log:myaddinstance', $authrole->id);

        block_learning_log\external\api::add_item('This should throw required_capability_exception');
    }
    ...
    public function test_add_item() {
        ...
        $raw = block_learning_log\external\api::add_item($todotext);
        $result = external_api::clean_returnvalue(block_learning_log\external\api::add_item_returns(), $raw);
    ...
    public function test_toggle_item() {
        ...
        $raw = block_learning_log\external\api::toggle_item($result['id']);
        $result = external_api::clean_returnvalue(block_learning_log\external\api::toggle_item_returns(), $raw);
    ...
    public function test_toggle_item_by_another_user() {
        ...
        block_learning_log\external\api::toggle_item($result['id']);
    }
    ...
    public function test_delete_item() {
        ...
        $result = external_api::clean_returnvalue(block_learning_log\external\api::add_item_returns(), $raw);
        $itemid = $result['id'];
        $this->assertTrue(block_learning_log\item::record_exists($itemid));

        $raw = block_learning_log\external\api::delete_item($itemid);
        $result = external_api::clean_returnvalue(block_learning_log\external\api::delete_item_returns(), $raw);
        $this->assertSame($result, $itemid);
        $this->assertFalse(block_learning_log\item::record_exists($itemid));
    }
    ...
    public function test_delete_item_by_another_user() {
        ...
        self::setUser($this->anotheruser);
        block_learning_log\external\api::delete_item($result['id']);
    }
}
