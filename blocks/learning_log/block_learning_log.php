...
class block_learning_log extends block_base {
    ...
    public function init(): void {
        ...
        $this->title = get_string('pluginname', 'block_learning_log');
    }
    ...
    public function get_content(): \stdClass {
        ...
        $this->content->text = $OUTPUT->render_from_template('block_learning_log/content', $list->export($OUTPUT));
    ...
    public function get_required_javascript(): void {
        ...
        $this->page->requires->js_call_amd('block_learning_log/control', 'init', [
            'instanceid' => $this->instance->id
        ]);
    }
