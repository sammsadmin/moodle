...
class update_venues extends \core\task\scheduled_task
{
    public function get_name()
    {
        // Shown on admin screens
        return get_string('update_venues', 'block_user_forms'); //get the string from lang/en/
    }
    ...
    public function execute()
    {
        ...
        update_venues_list(); //function to execute
    }
}